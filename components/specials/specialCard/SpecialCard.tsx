     ...
     <div className={style['card-container']}>
        <div style={{background: `url("${img}")`}} className={style['card-img']}/>
         ...
         <div className={style['card-digi-plus']}>
             {digiPlus !== "" ? <img className={style['digi-plus-icon']} src="https://www.digikala.com/static/files/3854bc8d.svg"/> : <span/>}
             {digiPlus}
         </div>
         <div className={style['prices-container']}>
            <div className={style['discount']}>{discount}%</div>
             <div className={style['old-price']}><NumberFormat value={price} displayType={'text'} thousandSeparator={true}/></div>
         ...
         <div className={style['progress-bar-container']}>
             <Progress className={style['progress-bar']} color="#ef394e" height='4px' completed={sold} />
         </div>
